...
parser = argparse.ArgumentParser(description="TSM based Motion Analytics")
...
parser.add_argument('--resume_from', default='', type=str, metavar='PATH',
...
# parser.add_argument('--save_every_ckpt', default=False, 
#                     action="store_true", help='save the best checkpoint only')
